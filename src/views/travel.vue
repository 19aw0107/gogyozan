<template>
  <div class="home">
    ...
    <section class="main_visual">
      <picture>
        <source media="(min-width: 1095px)" srcset="../assets/eyecatch/tabisaki1.png">
        <source media="(min-width: 850px)" srcset="../assets/eyecatch/tabisaki2.png">
        <img alt="GOGYOZANで記事を書いてスキルアップしませんか？" src="../assets/eyecatch/tabisaki3.png" class="eyecatch">
      </picture>
    </section>
    <!--メインのエリア-->
